...
bench_04_swin_transformer 是一个基于 Swin Transformer 模型的推理项目，用于在昇腾 Ascend NPU(310P) 上进行 Swin Transformer 模型的推理。
...
├── download_swin_transformer.py    # 用于下载 Swin Transformer 模型
